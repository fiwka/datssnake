...
public class Test implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        List<SnakeDto> snakes = gameStateResponse.getSnakes();
        SnakesMoveRequest snakesMoveRequest = new SnakesMoveRequest();
        snakes.forEach(snake -> snakesMoveRequest.addMovableSnake(new Snake(snake.getId()), Direction3D.Cords.Y.negative()));
